...
else
{
            ...
            <table border=1 cellspacing=0 cellpadding="15"><tbody bgcolor=#f1e3dd>
              ...
              <!--      <tr><td><a href="Paperpre.html">Paper Prsentation</a></td>
                           <!-- <a href=eventreg.html>Register Here</a></td> &nbsp;  &nbsp; &nbsp; !-->
 <!--   <td><a href="boxcricket.html">Box Cricket</a></td></tr>  !-->
	
<!--s<tr><td><a href="entrepreneur.html">Entrepreneurship Workshop</a></td>
